...
<div class="custom-box">
  <p>
    {{< icon "lightbulb" >}} <strong>Tip:</strong> If you're interested in collaborating on a project or have any questions about my work, feel free to reach out via GitHub or check my <a href="/contact" class="custom-link">contact page</a>.
  </p>
</div>
